...
admin.site.site_header = "FAM"
admin.site.site_title = "FAM Admin Portal"
admin.site.index_title = "FAM Admin"

# swagger
api_info = openapi.Info(
    title="FAM API",
    default_version="v1",
    description="API documentation for FAM App",
)
